...
<body>
    ...
    <div class="container">
        ...
        <form method="POST">
           ...
           <button onclick="window.location.href = 'photo.php?album_id=';">Back</button>
        ...
        <td>
        <a href='delete_comment.php?comment_id=" . $row["commen_id"] . "' class='delete-link' onclick=\"return confirm('Apakah Anda yakin ingin menghapus komentar ini?')\">Delete</a>

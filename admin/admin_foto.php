        ...
        <div class="photos-container">
            ...
            <div class="photo-card">
                ...
                <div class="photo-actions">
                    <!-- Edit Button -->
                    <a href="admin_edit_poto.php?id=<?php echo $photo['photo_id']; ?>" class="btn btn-edit">
                        <i class="fas fa-edit"></i>
                    </a>

                    <!-- Delete Button -->
                    <a href="admin_delete_foto?id=<?php echo $photo['photo_id']; ?>"
                        onclick="return confirm('Anda yakin ingin menghapus poto ini?')" class="btn btn-delete">
                ...
                <div class="photo-actions">
                    ...
                    <a href="admin_like.php" class="btn btn-like" data-photo-id="<?php echo $photo['photo_id']; ?>"
                        data-liked="<?php echo $photo['is_liked']; ?>" onClick="window.location.reload();">
                    ...
                    <!-- Comment Button -->
                    <a href="komen.php?photo_id=<?php echo $photo['photo_id']; ?>" class="btn btn-comment">

...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex-1 p-8">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="admin_add_album.php" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Album</a>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-8">
            <?php foreach ($albums as $album) : ?>
                <div class="bg-white p-4 rounded shadow-md relative">
                    <a href="admin_foto.php?album_id=<?php echo $album['album_id']; ?>">
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <!-- Tombol Edit -->
                        <a href="../admin/admin_edit_album.php?album_id=<?php echo $album['album_id']; ?>" class="text-gray-600 hover:text-blue-500">
                            <i class="fas fa-edit"></i>
                        </a>
                        
                        <!-- Tombol Delete -->
                        <a href="admin_delet_album.php?album_id=<?php echo $album['album_id']; ?>" class="text-gray-600 hover:text-red-500">

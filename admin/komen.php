...
<body>
    ...
    <div class="container">
        ...
        <button onclick="window.location.href = 'home_admin.php';">Back</button>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                header('Location: komen.php?photo_id=' . $photoID);
            } else {
        ...
        <td>
<a href='admin_delet_komen.php?comment_id=" . $row["commen_id"] . "' class='delete-link' onclick=\"return confirm('Apakah Anda yakin ingin menghapus komentar ini?')\">Delete</a>
        </td> <!-- Tautan untuk menghapus komentar -->
        </tr>";
                }
                echo "</table>";
            } else {
